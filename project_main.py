...
if __name__ == "__main__":
    ...
    #                                     filenames)
    textgraph_read_write.process_textgraph_questions('/media/poojaoza/extradrive1/datasets/tg2021-alldata-practice/data/questions.train.tsv',
                                                     '/media/poojaoza/extradrive1/datasets/tg2021-alldata-practice/data/json_questions/questions.train.json')
